"""
Train the Conditional 3D VAE model
"""
...
from src.training.trainer import VAELightningModule, create_trainer
...
def main():
    parser = argparse.ArgumentParser(description='Train Minecraft 3D VAE')
    ...
    if args.resume:
        ...
        model = VAELightningModule.load_from_checkpoint(args.resume, config=config)
    else:
    ...
    trainer = create_trainer(config, logger_name="minecraft_vae")
