...
class VAELightningModule(pl.LightningModule):
    ...
    def __init__(self, config: Dict):
        ...
        class_weights = torch.ones(num_classes) * 3.0  # Base weight 3.0 for all blocks (increased)
        class_weights[0] = 0.05  # Air gets extremely low weight (1.7% of others)
        # Wood blocks get MUCH higher weight (5.0x) to force trunk generation
